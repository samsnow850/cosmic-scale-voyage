...
const Mobile = () => {
  ...
  return <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="relative z-10 flex-1 p-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-block relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-yellow-300 via-orange-400 to-red-500 shadow-2xl cursor-pointer transition-all duration-300 hover:scale-110 mx-auto mb-2" style={{
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          {planetsData.map(planet => <Card key={planet.name} className="bg-gray-900 border-gray-700 cursor-pointer hover:bg-gray-800 transition-colors" onClick={() => setSelectedPlanet(planet)}>
              <CardContent className="p-4 text-center">
                <div className="w-16 h-16 rounded-full mx-auto mb-3 shadow-lg" style={{
      ...
      {/* Planet Detail Modal */}
      {selectedPlanet && <div className="fixed inset-0 z-50 bg-black bg-opacity-75 flex items-center justify-center p-4">
          <Card className="bg-gray-900 border-gray-700 max-w-sm w-full max-h-[80vh] overflow-y-auto">
            <CardHeader className="pb-4">
              <div className="flex justify-between items-center">
                ...
                <Button variant="outline" size="sm" onClick={() => setSelectedPlanet(null)} className="border-gray-600 hover:bg-gray-700 text-slate-950">
                  <X className="w-4 h-4" />
                </Button>
              </div>
            </CardHeader>
